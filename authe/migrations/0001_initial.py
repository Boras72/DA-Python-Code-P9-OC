    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('followed_by', models.ManyToManyField(related_name='followers', to='authe.user', verbose_name='suivi par')),
                ('follows', models.ManyToManyField(to='authe.user', verbose_name='suit')),
